      ...
      {isReservationConfirmed ? (
        <div className="reserva_confirmada">
          ...
          <img
            width="96"
            height="96"
            src="https://img.icons8.com/external-tal-revivo-regular-tal-revivo/96/external-check-scheduled-objectives-from-planned-calendar-events-date-regular-tal-revivo.png"
            alt="external-check-scheduled-objectives-from-planned-calendar-events-date-regular-tal-revivo"
          />
